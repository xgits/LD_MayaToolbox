...
# About LD MayaToolbox
    ...
    2. Second option is to buy a pro version on gumroad here <script src="https://gumroad.com/js/gumroad.js"></script><a class="gumroad-button" href="https://gum.co/xgits">Gumroad</a>:  the pro version has a few functions with bonus performance. 
...
# 简介 LD MayaToolbox
    ...
    <script src="https://gumroad.com/js/gumroad.js"></script><a class="gumroad-button" href="https://gum.co/xgits">Gumroad</a>
    两个版本都可用于商业和个人使用.
